...
public class AlternatorApacheClient implements SdkHttpClient {
    private static final Logger log = Logger.loggerFor(AlternatorApacheClient.class);
    ...
    AlternatorApacheClient(ConnectionManagerAwareHttpClient httpClient,
    ...
    private AlternatorApacheClient(DefaultBuilder builder, AttributeMap resolvedOptions) {
    ...
    private ConnectionManagerAwareHttpClient createClient(AlternatorApacheClient.DefaultBuilder configuration,
    ...
    public ExecutableHttpRequest prepareRequest(HttpExecuteRequest request) {
        ...
        apacheRequest.setHeader("Host", AlternatorHttpClient.FAKE_HOST);
     ...
     * </pre>
     */
    public interface Builder extends SdkHttpClient.Builder<AlternatorApacheClient.Builder> {
    ...
    private static final class DefaultBuilder implements Builder {
        ...
        public SdkHttpClient buildWithDefaults(AttributeMap serviceDefaults) {
            ...
            return new AlternatorApacheClient(this, resolvedOptions);
        }
    }

    private static class ApacheConnectionManagerFactory {

        public HttpClientConnectionManager create(AlternatorApacheClient.DefaultBuilder configuration,
                                                  AttributeMap standardOptions) {
        ...
        private ConnectionSocketFactory getPreferredSocketFactory(AlternatorApacheClient.DefaultBuilder configuration,
                                                                  AttributeMap standardOptions) {
